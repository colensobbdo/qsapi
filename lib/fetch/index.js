...
var request = function request(params) {
    ...
    if (opts.hasOwnProperty('headers') && opts.headers.hasOwnProperty(['content-type']) && opts.headers['content-type'].toLowerCase() === 'application/x-www-form-urlencoded' && Object.keys(opts.data).length > 0) {

        return instance[opts.method.toLowerCase()](url, _querystring2.default.stringify(opts.data));
    } else {
